...
import Shield from 'virtual:icons/ph/shield-chevron?raw&width=1.5em&height=1.5em'
import Dice from 'virtual:icons/ph/dice-five?raw&width=1.5em&height=1.5em'
import Trophy from 'virtual:icons/ph/trophy?raw&width=1.5em&height=1.5em'
import MoonStars from 'virtual:icons/ph/moon-stars?raw&width=1.5em&height=1.5em'
import Crown from 'virtual:icons/ph/crown?raw&width=1.5em&height=1.5em'
import Sword from 'virtual:icons/ph/sword?raw&width=1.5em&height=1.5em'
import Coins from 'virtual:icons/ph/coins?raw&width=1.5em&height=1.5em'
import Bomb from 'virtual:icons/ph/bomb?raw&width=1.5em&height=1.5em'
