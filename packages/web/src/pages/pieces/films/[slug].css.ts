...
export const filmContainer = style({
	position: 'relative',
	display: 'flex',
	margin: 'auto',
	gap: vars.space[5],
...
export const filmDiscuss = style({})

export const filmDetails = style({
	lineHeight: '1.5',
	width: '100%',
