...
The official web viewer and editor for Luzzle archives. Because your data
deserves to look good and be easy to manage. 💅

## Overview

Luzzle Web Explorer is a beautiful, fast, and responsive web application for
browsing and managing your personal archive. It connects to your Luzzle data to
display your books, films, and writings in a rich interface, and provides a
secure editor for making changes on the go.
