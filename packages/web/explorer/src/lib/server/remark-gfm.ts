...
export type Options = MicromarkStrikethroughOptions & MdastTableOptions & { plugins?: PluginOptions}
...
const remarkGfm: Plugin<[Options?]> = function(this: Processor, options?: Options) {
  ...
  const pluginOptions: PluginOptions = { ...{ autolinkLiteral: true, footnote: true, strikethrough: true, table: true, tasklist: true }, ...options?.plugins}
