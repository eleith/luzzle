...
<dialog bind:this={dialog}>
	<form method="post" action="/editor/piece/{data.file}?/delete">
...
<div class="piece-page">
	<div class="header">
		<div style="display:flex; gap: var(--space-2);">
			...
			<a href="/editor/directory/{data.directory === '.' ? '' : data.directory}">
	...
	<div class="editor-container">
		<MarkdownEditor bind:value={rawContent} editorThemes={data.editorThemes} type={data.type} />
	</div>
</div>
