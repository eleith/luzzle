...
function getRssFeedFromPieces(pieces: PublicWebPiece[], tag?: string) {
...
function getJsonFeedFromPieces(pieces: PublicWebPiece[], tag?: string) {
	const feedTitle = tag ? `${config.content.text.title} | tag: ${tag}` : config.content.text.title
	const feed: FeedJson = {
		title: feedTitle,
		description: config.content.text.description,
...
function getMarkdownFeedFromPieces(pieces: PublicWebPiece[], tag?: string) {
	const feedTitle = tag ? `${config.content.text.title} | tag: ${tag}` : config.content.text.title
