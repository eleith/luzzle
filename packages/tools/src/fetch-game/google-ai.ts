	...
	const instruction = `you will generate metadata a single video game using the following JSON schema:

			{
				...
				"properties": {
					...
					"keywords": {
						"description": "A comma separated list of 5 to 20 keywords that reference a wide variety of topics related to this video game like theme, genre, setting, characters, gameplay mechanics, and other keywords that could be used to link to games with similar keywords",
						"type": "string"
					},
					"date_published": {
				...
				text: `
					{
						...
						"keywords": "action-adventure, fantasy, open-world, puzzle, exploration, Nintendo, classic, iconic, Zelda, Link, Hyrule, Ganon, Triforce, Master Sword, dungeons, magic, princess rescue, hero's journey, high fantasy, medieval, sword and sorcery, timeless, family-friendly",
