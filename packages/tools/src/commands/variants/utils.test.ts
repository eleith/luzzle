...
describe('src/commands/variants/utils', () => {
	...
	test('should handle assets with paths', () => {
		const path = getAssetPath('books', '1', '/path/to/image.jpg', { format: 'avif', width: 100 })
		expect(path).toBe('books/1/image.w100.avif')
